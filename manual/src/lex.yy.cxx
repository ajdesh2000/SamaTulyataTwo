#line 2 "./src/lex.yy.cxx"

#line 4 "./src/lex.yy.cxx"
...
static yyconst flex_int16_t yy_accept[24] =
    {   0,
        0,    0,   18,   17,   17,    8,   12,   10,   11,   13,
       15,    6,    2,    5,   16,    1,    9,   14,   15,    4,
        7,    3,    0
    } ;
...
static yyconst flex_uint16_t yy_base[24] =
    {   0,
        0,    0,   21,   22,   10,   22,   22,   22,   22,   22,
       11,    8,    7,    6,   22,   22,   22,   22,    7,   22,
       22,   22,   22
    } ;
...
YY_DECL
{
	...
	{
#line 11 "./src/rpcalc.l"

#line 706 "./src/lex.yy.cxx"
...
case 1:
YY_RULE_SETUP
#line 12 "./src/rpcalc.l"
{yylval.operetor = strdup("_"); return UNDER;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 13 "./src/rpcalc.l"
{yylval.operetor = strdup("="); return EQ; }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 14 "./src/rpcalc.l"
{yylval.operetor = strdup(">=");return GRETEREQ;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 15 "./src/rpcalc.l"
{yylval.operetor = strdup("<="); return LESSEQ;}
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 16 "./src/rpcalc.l"
{yylval.operetor = strdup(">"); return GRETER;}
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 17 "./src/rpcalc.l"
{yylval.operetor = strdup("<"); return LESS;}
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 18 "./src/rpcalc.l"
{yylval.operetor = strdup("=="); return EQEQ;}
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 19 "./src/rpcalc.l"
{yylval.operetor = strdup("&"); return AND;}
	YY_BREAK
case 9:
YY_RULE_SETUP
#line 20 "./src/rpcalc.l"
{yylval.operetor = strdup("|"); return OR;}
	YY_BREAK
case 10:
YY_RULE_SETUP
#line 21 "./src/rpcalc.l"
{yylval.operetor = strdup("+"); return PLUS;}
	YY_BREAK
case 11:
YY_RULE_SETUP
#line 22 "./src/rpcalc.l"
{yylval.operetor = strdup("-"); return MINUS;}
	YY_BREAK
case 12:
YY_RULE_SETUP
#line 23 "./src/rpcalc.l"
{yylval.operetor = strdup("*"); return MULT;}
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 24 "./src/rpcalc.l"
{yylval.operetor = strdup("/"); return DIV; }   
	YY_BREAK
case 14:
YY_RULE_SETUP
#line 25 "./src/rpcalc.l"
{yylval.operetor = strdup("!="); return NOTEQ; }
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 26 "./src/rpcalc.l"
{ yylval.constant = atoi(yytext) ; return NUM ; }
	YY_BREAK
case 16:
YY_RULE_SETUP
#line 27 "./src/rpcalc.l"
{ yylval.literal = yytext[0] ; return CHAR ; }
	YY_BREAK
case 17:
YY_RULE_SETUP
#line 28 "./src/rpcalc.l"
ECHO;
	YY_BREAK
#line 848 "./src/lex.yy.cxx"
